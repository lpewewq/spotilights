...
class SharedData:
    def __init__(self) -> None:
        ...
        self._audio_analysis: AudioAnalysis = None
    ...
    async def get_audio_analysis(self) -> AudioAnalysis:
    ...
    async def set_audio_analysis(self, audio_analysis: AudioAnalysis) -> None:
        async with self._audio_analysis_lock:
